...
export const Route = createRootRoute({
  head: () => ({
    ...
    links: [
      { rel: "icon", type: "image/png", sizes: "192x192", href: "https://cdn.jsdelivr.net/gh/rrana8212/Gullak@main/public/shortcut-192.png" },
      { rel: "apple-touch-icon", sizes: "192x192", href: "https://cdn.jsdelivr.net/gh/rrana8212/Gullak@main/public/shortcut-192.png" },
